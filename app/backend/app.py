...
# AZURE_SEARCH_INDEX = os.environ.get("AZURE_SEARCH_INDEX1") or "sqldb-index"
...
APPLICATION_TITLE = os.environ.get("APPLICATION_TITLE") or "Veraqor AI Information Assistant"
